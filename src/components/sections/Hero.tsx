      ...
      <Container className="hero__layout">
        <div className="hero__content">
          ...
          <div className="hero__facts hero-animate hero-delay-4" aria-label="Project highlights">
            {hero.facts.map((fact) => (
              <div className="hero-fact" key={fact.value}>
          ...
          <div className="hero__actions hero-animate hero-delay-5">
            <LeadTrigger className="button button--primary" intent="Get the latest price sheet">
              <span>{hero.primaryCta}</span><ArrowUpRight size={15} aria-hidden="true" />
            </LeadTrigger>
            <LeadTrigger className="button button--glass" intent="Book a free site visit">
              <span>{hero.secondaryCta}</span><ArrowRight size={15} aria-hidden="true" />
            </LeadTrigger>
          </div>
